...
class HandEyeCalibrator:
    ...
    def run_calibration_process(self):
        ...
        calibration_poses = [
            ...
            [27.5, -36.2, 86.0, -117.1, 97.2, -26.6],
            [84.64, -31.9, 72.0, -163.4, 114.2, 40.3],
            [61.2, -59.9, 103.6, -144.2, 109.0, 59.2],
            [93.3, -70.4, 79.0, -166.1, 75.0, 3.1],
            [91.8, -49.1, 101.5, -166.5, 125.3, 28.1]
        ]
