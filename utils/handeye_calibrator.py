...
class HandEyeCalibrator:
    ...
    def run_calibration_process(self):
        ...
        calibration_poses = [
            ...
            [-94.23, -48.53, 122.47, 5.48, 27.53, 0.4],
            [-175.2, 47.56, 56.07, -93.46, -99.26, 50.67],
            [-135.25, 46.81, 39.31, -95.18, -77.57, 161.99],
            [-14.61, 56.54, 13.91, -101.29, 96.96, 159.93],
            [-19.73, 41.5, 108.46, -93.87, 101.27, 159.78],
            [-16.81, -16.84, 14.63, -68.99, 87.1, 173.09],
            [-38.06, 30.0, 42.83, -85.73, 66.28, 238.51],
            [-38.36, -5.54, -103.2, -112.31, 124.01, 238.5],
            [-129.04, 68.2, -84.35, 39.4, 93.22, 238.38],
            [-165.01, -4.82, -96.88, 91.79, 110.36, 237.74],
            [-168.49, -29.82, -115.24, 103.9, 105.28, 199.04],
            [-174.92, 72.4, -81.25, 94.21, 89.04, 198.97],
